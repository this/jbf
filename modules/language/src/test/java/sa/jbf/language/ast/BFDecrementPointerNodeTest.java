...
class BFDecrementPointerNodeTest {
    @Test
    void exceptionOnPointerDecrementTest() {
        final var source = "><<."; // increase pointer by one and then decrease it by two
        ...
        assertEquals(2, polyglotException.getSourceLocation().getCharIndex());
